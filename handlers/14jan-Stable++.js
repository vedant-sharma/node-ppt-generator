        ...
        for (const part of seriesContent) {
          if (part.type === "text") {
            ...
            for (const word of words) {
              const wordWidth = word.length * 0.1;
      
              if (xPosition + wordWidth > MAX_INLINE_SPACE) {
                xPosition = LEFT_MARGIN;
                yPosition += LINE_HEIGHT; // Standard line height
              }
